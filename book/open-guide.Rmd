...
urlcolor: blue
link-citations: yes
description: "Information about TOP guidelines at APA journals."
url: https://apa-osm.github.io/open-guide/
github-repo: apa-osm/open-guide
...
**The guide is in draft form. We are starting with guidance for editors and authors. We will be adding guidance for reviewers soon. We welcome feedback and suggestions for further guidance.**
...
# Transparency and Openness Statements {#editors-top}
...
# Registered Reports {#editors-registered-reports}
...
# Preregistration  {#editors-prereg}
...
# Open Materials {#editors-open-materials}
...
# Preprints and Postprints {#editors-preprints}
...
[What to Check](https://www.dropbox.com/s/8jv2n0j3mlkhkrj/TOP_GuidanceforReviewers.docx){target="_blank"} in TOP statements for journals with TOP Level 1 or Level 2
